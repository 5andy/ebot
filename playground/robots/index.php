...
try {
    ...
    // Simple code patch for ajax requests
    // TODO - Add security checks...
    if (isset($_GET['ajax']) && $_GET['ajax'] == '1' && isset($_GET['type']) && $_GET['type'] == 'car') {
        // DO ROBOT!
        require_once ('application/robots.class.php');
        $robots = new robots($_GET['type']);
        $ajaxResponse = $robots->getResponse();
        echo $ajaxResponse;
    } else {
